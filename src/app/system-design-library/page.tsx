...
export default function Page() {
  ...
  useEffect(() => {
    // Detect full reload vs client navigation
    ...
    if (navType === "reload") {
      // only fetch on full page reload
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 mt-4 md:mt-0">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h1 className="text-2xl font-semibold">System Design Library</h1>
        <p className="text-sm text-muted-foreground">
          Source repo:{" "}
          <a
            href="https://github.com/Aditya-Dawadikar/Distributed_Systems_Engineer_2026"
            target="_blank"
            rel="noopener noreferrer"
            className="underline"
          >
            Aditya-Dawadikar/Distributed_Systems_Engineer_2026
          </a>
        </p>
      </div>
