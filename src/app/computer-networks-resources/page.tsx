  ...
  return (
    <div className="max-w-3xl mx-auto py-8 mt-4 md:mt-0">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h1 className="text-2xl font-semibold text-zinc-100">Computer Networks Resources</h1>
        <p className="text-sm text-zinc-300">
          Source repo:{" "}
          <a
            href="https://github.com/Aditya-Dawadikar/Computer-Networks-InterviewPrep"
            target="_blank"
            rel="noopener noreferrer"
            className="underline text-zinc-100 hover:text-white"
          >
            Aditya-Dawadikar/Computer-Networks-InterviewPrep
          </a>
        </p>
      </div>
